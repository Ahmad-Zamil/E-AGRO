...
use App\Http\Middleware\ValidAdminOrSellerOrVendor;
use App\Http\Middleware\ValidAdminOrCustomerOrVendor;
...
//vendor status
Route::get('/updateVendorStatus/{id}',[VendorController::class,'approvedVendorEdit'])->name('updateVendorStatus/{id}')->middleware([ValidAdmin::class]);
Route::post('/approveVendor',[VendorController::class,'approvedVendor'])->name('approveVendor');
//add and show admin profile picture
...
// Route::get('/sellerOrder/{id}',[CartController::class,'sellerOrder'])->name('/sellerOrder/{id}');
...
Route::post('/vendoraddProduct',[ProductController::class,'vendorlistingProduct'])->name('vendor.addProduct');
Route::get('/vendoraddProduct',[ProductController::class,'vendoraddProduct'])->name('vendor.listProduct');
...
// common 
Route::get('/productList',[ProductController::class,'productList'])->name('productList')->middleware([ValidAdminOrSellerOrVendor::class]);
...
Route::get('/customerOrders/{id}',[CartController::class,'customerOrders'])->name('customerOrders')->middleware([ValidAdminOrCustomerOrVendor::class]);
...
Route::get('/FtoV_Orderlist',[OrderViewController::class,'FtoV_Orderlist'])->name('FtoV.Orderlist');
Route::get('/VtoC_Orderlist',[OrderViewController::class,'VtoC_Orderlist'])->name('VtoC.Orderlist');

/// seller part order view
Route::get('/myOrderlist',[OrderViewController::class,'My_Orderlist'])->name('my.Orderlist');

Route::get('/productlist',[ProductController::class,'My_vendorProduct'])->name('my.productlist');
