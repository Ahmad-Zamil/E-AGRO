    ...
    <div class="col-9">
      ...
      "  style="min-height: 88vh; width: 100%">
            <div>
                ...
                @endif
                <h4 class="my-4 fw-bold text-uppercase">Farmer List</h4>
                {{-- {{ $admin->name }} --}}
                <table class="table table-borded table-striped">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="">
                            ...
                            <a type = "submit" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm" href={{ "deleteSeller/" .$seller->id }}>Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
