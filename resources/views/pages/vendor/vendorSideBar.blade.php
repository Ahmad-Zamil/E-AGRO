...
<div class="py-5">
    ...
    <!-- <div class="text-center">
        <a href="{{ route('vendor.listProduct') }}" class="btn custom my-2 w-75" style="text-align: left"><i class="fas fa-bars  px-2 me-2"></i>My stock</a>
    </div> -->
    <!-- <div class="text-center">
        <a href="{{ route('vendor.addProduct') }}" class="btn custom my-2 w-75" style="text-align: left"><i class="fas fa-bars  px-2 me-2"></i>Selling Items</a>
    </div> -->

    <div class="text-center">
        <a href="{{ route('productList') }}" class="btn custom my-2 w-75" style="text-align: left"><i class="fas fa-bars  px-2 me-2"></i>Selling Items List</a>
    </div>

    <div class="text-center">
        <a class="btn custom my-2 w-75" style="text-align: left" href={{ "/customerOrders/" .session('id') }}><i class="fas fa-bars  px-2 me-2"></i>Customer Order</a>
    </div>
