                    ...
                    <table class="table table-borded table-striped table-hover">
                        ...
                        <tr class="text-center">
                            ...
                            <!-- <td>
                                ...
                                <a type = "submit" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm mt-3" href={{ "deleteProduct/" .$product->id
                                    }}>Delete</a>
                            </td> -->
                        </tr>
                        @endforeach
                ...
                <div>
                    ...
                    <table class="table table-borded table-striped table-hover">
                        <tr class="text-center">
                            ...
                            @php $s = 0 @endphp
                        @foreach($allProducts as $product)
                            @if(session('id') == $product->vendorId)
                            <tr class="text-center">
                                <td>{{$s}}</td>
                                <td>{{$product->name}}</td>
                                <td>{{$product->category}}</td>
                    ...
                    <a class="btn btn-primary btn-sm mb-3 px-3" href="{{route('vendor.addProduct')}}">Add</a>
